export const questions = [
  {
    id: 1,
    question: "Como abrir um chamado para TI?",
    answer: "Acesse o sistema interno através do link 'Suporte' na sua área de trabalho. Preencha a descrição detalhada e anexe um print da tela inteira com o erro."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    tip: "Caminho no portal: Suporte > Impressoras > Instalar"
  },
  {
    id: 5,
  ...
  },
  {
    ...
    tip: "Caminho no portal: Hardware > Troca de Peça > Instalação"
  },
  {
    id: 9,
    question: "Quero um ramal do next ip em minha máquina",
    answer: "Abra um chamado solicitando o ramal do next ip. Informe um número de ramal espelho, pode ser de um colega da equipe.",
    tip: "Caminho no portal: Telefonia > Ramal Next IP > Configurar"
  }
];